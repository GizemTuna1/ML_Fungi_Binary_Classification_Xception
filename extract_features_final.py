# -*- coding: utf-8 -*-
"""
Created on Fri Aug 18 19:44:03 2023
...
for img_path in train_path.glob("AFU/*.jpg"):
    try:
...
for img_path in train_path.glob("Not-AFU/*.jpg"):
    try:
        img = Image.open(img_path)
        img = img.resize((299, 299))
        image_array = image.img_to_array(img)
...
joblib.dump(y_train,os.path.join(folder_path, "y_train.dat"))